...
def get_args():
    ...
    parser.add_argument('--lr_schedule', type=str, default='bag_of_tricks', choices=(
                        'trades', 'bag_of_tricks', 'madry'), help='Learning rate schedule')
    ...
    parser.add_argument('--loss', default='trades', type=str,
                        choices=('trades', 'pgd', 'mixed'), help='Which loss to use: TRADES or PGD')
    ...
    # DAFA argument
    parser.add_argument('--rob_fairness_algorithm', default='dafa', type=str, choices=('dafa', 'none'), help='use or not to use dafa')
